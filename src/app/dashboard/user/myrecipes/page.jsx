...
const MyRecipesPage = () => {
  ...
  if (loading) return <div className="text-center mt-32">Loading your recipes...</div>;

  return (
    <div className="max-w-5xl mx-auto mt-24 px-4">
      <h2 className="text-3xl font-bold mb-6 text-center">My Recipes ({recipes.length})</h2>
